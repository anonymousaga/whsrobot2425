...
def write_gconf():
    write_reg(0, GCONF, ((multistep_filt*256 + 512*test_mode)+(I_scale_analog + 2*internal_Rsense + 4 *
              en_spreadcycle + 8*shaft + 16*index_otpw + 32*index_step + 64*pdn_disable + 128*mstep_reg_select)))
